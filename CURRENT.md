...
> Generated automatically. Do not hand edit, it is overwritten every autosave.
> **Any session touching this project reads this file before opening any build.**

| | |
|---|---|
| Stamped | 2026-09-24 20:08 |
| Stamped from | Samuel's Windows Desktop |
| Last commit | 2026-09-24 19:52 |
| Last commit was | Samuel HQ.app: a board that owns one monitor while he uses the other |
| Branch | main |
...
- `TV14-board.html` · 2026-09-24 20:08
- `TV13-live-board.html` · 2026-09-21 06:08
...
Project context lives in the brain repo: `samuel-hq`.
Clone or pull it for memory, briefs, opinions, and the house design playbook.
